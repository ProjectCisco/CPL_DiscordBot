...
ROLES_WHEN_REGISTED = [615780983047979008,
                       628464552882995200, 444330435070132235, 577702305999093763]

# Register uuid
SMURF_IDENTIFIER_LOG_CHANNEL = 1173669840045752350
MOD_CONTACT_CHANNEL = 1181789238669344830
...
# Only Used if QUIT_APPLY_BASIC_SUSPENSION is False
QUIT_SUSPENSION_TIME = [1, 2, 3, 5, 8, 13, 21, 34, 55, 180]
...
LEADERBOARDS: Dict[str, Dict[str, Any]] = {
    ...
    'Duel': {'channel_id': 1181731355026014279,
                    'message_id': [1181731461418721302, 1181731464556064928, 1181731466632249355, 1181731470730080348, 1181731472500080711,
                                1181731474941149244, 1181731477378052167, 1181731479999500369, 1181731498110505070, 1181731531992088668
        ]
    },
    ...
    'PBC-Teamer': {'channel_id': 1181729143092678717,
                    'message_id': [
            1181737942935425116, 1181737947112939610, 1181737950472573019, 1181737953475690526, 1181737955262468178,
            1181737958211063820, 1181737960899608606, 1181737963684630630, 1181737966033440798, 1181737988720447569
        ]
    }
}
SEASON_LEADERBOARDS: Dict[str, Dict[str, Any]] = {
    ...
    'Teamer': {
        ...
        'message_id': [
            1121536481144614913, 1121529798372626493, 1121529800876621906, 1121529803032494251, 1121529804609552405,
...
VOTE_SETTINGS: Dict[str, List[Tuple[EMOJI, str]]] = {
    ...
    DRAFT_MODE_TITLE: [("✅", DraftMode.WITH_TRADE.value), ("🚫", DraftMode.NO_TRADE.value),
                       ("🙈", DraftMode.BLIND.value), ("❓", DraftMode.RANDOM.value)]
}
...
TEAM_VOTE_SETTINGS: Dict[str, List[Tuple[EMOJI, str]]] = {
    ...
    DRAFT_MODE_TITLE: [(NB[2], DraftMode.DRAFT_2.value), ("🌍", DraftMode.CWC.value),
                       (NB[9], DraftMode.DDRAFT_9_3_1.value), ("❓", DraftMode.RANDOM.value)]
}
